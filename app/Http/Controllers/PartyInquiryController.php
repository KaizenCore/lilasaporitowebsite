...
class PartyInquiryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $booking = PartyBooking::create([
            ...
            'alternate_date' => $validated['alternate_date'],
            'alternate_time' => $validated['alternate_time'],
            'event_type' => $validated['event_type'],
            'event_details' => $validated['event_details'],
            'honoree_name' => $validated['honoree_name'],
            'honoree_age' => $validated['honoree_age'],
            ...
            'party_painting_id' => $validated['party_painting_id'],
            'wants_custom_painting' => $request->boolean('wants_custom_painting'),
            'custom_painting_description' => $validated['custom_painting_description'],
