...
class PartyInquiryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'event_type' => 'required|in:birthday,corporate,bridal_shower,bachelorette,team_building,fundraiser,other',
            'event_details' => 'nullable|string|max:1000',
            'honoree_name' => 'nullable|string|max:255',
            'honoree_age' => 'nullable|integer|min:1|max:120',
            'fundraiser_org_name' => 'required_if:event_type,fundraiser|nullable|string|max:255',
            'fundraiser_cause' => 'required_if:event_type,fundraiser|nullable|string|max:255',
            'fundraiser_type' => 'required_if:event_type,fundraiser|nullable|in:donated,fundraising',
        ...
        $booking = PartyBooking::create([
            ...
            'fundraiser_org_name' => $validated['fundraiser_org_name'] ?? null,
            'fundraiser_cause' => $validated['fundraiser_cause'] ?? null,
            'fundraiser_type' => $validated['fundraiser_type'] ?? null,
