            ...
            <div class="p-6">
                <form action="{{ route('admin.classes.update', $class) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location', $class->location) }}" required placeholder="123 Main St, Brooklyn, NY 11211"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="location_public" id="location_public" value="{{ old('location_public', $class->location_public) }}" placeholder="Williamsburg, Brooklyn"
                    ...
                    @php
                        $existingTicketTypes = old('ticket_types', $class->ticket_types ?? []);
                    @endphp
                    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg" x-data="{
                        hasTicketTypes: {{ !empty($existingTicketTypes) ? 'true' : 'false' }},
                        ticketTypes: {{ json_encode($existingTicketTypes) ?: '[]' }},
                        addType() {
                    ...
                    <!-- Party Event Section -->
                    <div class="mb-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg" x-data="{ isParty: {{ old('is_party_event', $class->is_party_event) ? 'true' : 'false' }} }">
                        <div class="flex items-center mb-4">
                            <input type="checkbox" name="is_party_event" id="is_party_event" value="1" x-model="isParty"
                                {{ old('is_party_event', $class->is_party_event) ? 'checked' : '' }}
                        ...
                        <div x-show="isParty" x-cloak class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="small_party_price_cents" id="small_party_price_cents" value="{{ old('small_party_price_cents', $class->small_party_price_cents ?? 15000) }}" min="0"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="small_party_size" id="small_party_size" value="{{ old('small_party_size', $class->small_party_size ?? 6) }}" min="1"
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-purple-500 focus:ring-purple-500">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="large_party_price_cents" id="large_party_price_cents" value="{{ old('large_party_price_cents', $class->large_party_price_cents ?? 25000) }}" min="0"
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-purple-500 focus:ring-purple-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="large_party_size" id="large_party_size" value="{{ old('large_party_size', $class->large_party_size ?? 12) }}" min="1"
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-purple-500 focus:ring-purple-500">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="additional_guest_price_cents" id="additional_guest_price_cents" value="{{ old('additional_guest_price_cents', $class->additional_guest_price_cents ?? 2000) }}" min="0"
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-purple-500 focus:ring-purple-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="max_party_size" id="max_party_size" value="{{ old('max_party_size', $class->max_party_size ?? 20) }}" min="1"
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-purple-500 focus:ring-purple-500">
                                </div>
                            </div>
