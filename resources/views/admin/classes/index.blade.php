                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-sm text-gray-500">{{ Str::limit($class->short_description, 50) }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $class->class_date->format('M d, Y') }}</div>
                                            <div class="text-sm text-gray-500">{{ $class->class_date->format('g:i A') }}</div>
                                        </td>
