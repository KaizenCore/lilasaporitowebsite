<x-admin-layout>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6" x-data="{ pricingType: '{{ old('pricing_type', 'flat_per_person') }}', tiers: {{ json_encode(old('tier_pricing', [['min' => 4, 'max' => 6, 'price_cents' => 3500]])) }} }">
                <form action="{{ route('admin.parties.pricing.store') }}" method="POST">
                    @csrf

                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Name *</label>
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g., Standard Kids Party"
                    ...
                    <div x-show="pricingType === 'flat_per_person'" class="mb-4">
                        ...
                        <input type="number" name="base_price_cents" id="base_price_cents" value="{{ old('base_price_cents', 3500) }}" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" name="minimum_guests" id="minimum_guests" value="{{ old('minimum_guests', 4) }}" required min="1"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
                        <div>
                            <label for="maximum_guests" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Maximum Guests</label>
                            <input type="number" name="maximum_guests" id="maximum_guests" value="{{ old('maximum_guests') }}" min="1"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <p class="mt-1 text-sm text-gray-500">Leave blank for no limit</p>
                        </div>
                    </div>
                    ...
                    <div class="border-t pt-4 mb-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="lila_venue_fee_cents" id="lila_venue_fee_cents" value="{{ old('lila_venue_fee_cents') }}" min="0"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <p class="mt-1 text-sm text-gray-500">Flat fee when Lila hosts</p>
                            </div>
                            <div>
                                <label for="lila_venue_max_capacity" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Max Capacity *</label>
                                <input type="number" name="lila_venue_max_capacity" id="lila_venue_max_capacity" value="{{ old('lila_venue_max_capacity', 8) }}" required min="1" max="50"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="custom_painting_fee_cents" id="custom_painting_fee_cents" value="{{ old('custom_painting_fee_cents') }}" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        <p class="mt-1 text-sm text-gray-500">Additional fee if customer wants a custom painting design</p>
                    </div>
                    ...
                    <div class="flex justify-end gap-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700">Create Config</button>
                    </div>
                </form>
            </div>
        </div>
