                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" x-data="productForm()">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description" id="description" rows="6" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 @error('description') border-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div x-show="productType === 'digital'" class="mb-6 border-t pt-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload a new file to replace the current one. Maximum file size: 50MB</p>
                            @error('digital_file')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-6 border-t pt-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload a new image to replace the current one. Maximum file size: 2MB (jpeg, png, jpg, gif)</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
