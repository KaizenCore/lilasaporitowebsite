                ...
                <table role="presentation" style="width: 600px; max-width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px; text-align: center;">
                            ...
                            <p style="margin: 10px 0 0; color: #6b7280; font-size: 16px;">Thank you for booking with FrizzBoss, {{ $user->name }}!</p>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;">
                                        ...
                                        <p style="margin: 5px 0 0; color: #1f2937; font-size: 16px; font-weight: 600;">{{ $artClass->title }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;">
                                        <p style="margin: 0; color: #6b7280; font-size: 14px;">Date & Time</p>
                                        <p style="margin: 5px 0 0; color: #1f2937; font-size: 16px; font-weight: 600;">{{ $artClass->class_date->format('l, F j, Y') }}</p>
                                        <p style="margin: 2px 0 0; color: #6b7280; font-size: 14px;">{{ $artClass->class_date->format('g:i A') }} ({{ $artClass->duration_minutes }} minutes)</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;">
                                        <p style="margin: 0; color: #6b7280; font-size: 14px;">Location</p>
                                        <p style="margin: 5px 0 0; color: #1f2937; font-size: 16px; font-weight: 600;">{{ $artClass->location }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 0;">
                                        <p style="margin: 0; color: #6b7280; font-size: 14px;">Amount Paid</p>
                                        <p style="margin: 5px 0 0; color: #9333ea; font-size: 20px; font-weight: bold;">{{ $artClass->formatted_price }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
