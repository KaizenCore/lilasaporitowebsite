...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
            <!-- Admin Navigation -->
            <nav class="bg-purple-700 dark:bg-purple-900 border-b border-purple-800 dark:border-purple-950">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-4 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    <button @click="open = !open" class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('admin.classes.*', 'admin.gallery.*') ? 'border-white text-white' : 'border-transparent text-purple-100 hover:text-white hover:border-purple-300' }} text-sm font-medium">
                                        Classes
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                            <x-theme-toggle class="text-white hover:bg-purple-600 dark:hover:bg-purple-800" />
                            <div class="relative">
                ...
                <div id="responsive-nav" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <div class="pl-3 pr-4 py-2 {{ request()->routeIs('admin.classes.*', 'admin.gallery.*', 'admin.calendar.*') ? 'bg-purple-800' : '' }}">
