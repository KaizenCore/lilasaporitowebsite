<x-public-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <a href="{{ route('store.index') }}" class="inline-flex items-center text-purple-600 hover:text-purple-700 font-medium transition">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
                ...
                <div>
                    ...
                    @else
                        <div class="w-full h-96 bg-gradient-to-br from-purple-200 to-pink-200 flex items-center justify-center rounded-xl shadow-lg">
                ...
                <div>
                    <div class="mb-4">
                        @if($product->category)
                            <a href="{{ route('store.category', $product->category->slug) }}" class="text-sm text-purple-600 hover:text-purple-800 font-medium">
                    ...
                    <div class="mb-6 flex flex-wrap gap-2">
                        ...
                        @if($product->is_featured)
                            <span class="inline-block px-3 py-1 text-sm font-semibold bg-pink-100 text-pink-800 rounded-full">
                                Featured
                            </span>
                        @endif
                    </div>
                    ...
                    @if($product->product_type === 'physical')
                        <div class="mb-6">
                            ...
                            @elseif($product->stock_quantity < 10)
                                <span class="text-orange-600 font-semibold">Only {{ $product->stock_quantity }} left in stock!</span>
                            @else
                                <span class="text-green-600 font-semibold">In Stock</span>
                            @endif
                        </div>
                    ...
                    <div class="mb-6">
                        @if($product->is_out_of_stock)
                            <button disabled class="w-full bg-gray-300 text-gray-500 px-6 py-4 rounded-xl font-semibold cursor-not-allowed text-lg">
                                Out of Stock
                            </button>
                        @else
                            ...
                            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span class="text-lg font-bold text-purple-600">{{ $relatedProduct->formatted_price }}</span>
                                    </div>
                                </div>
                            </div>
                        </a>
